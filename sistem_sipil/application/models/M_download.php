...
class M_download extends CI_Model{
	...
	function get_all_files(){
		$hsl=$this->db->query("SELECT file_id,pengguna_id,Nama_file,file_oleh,file_data FROM tbl_files ORDER BY file_id DESC");
		return $hsl;
	}
	function simpan_file($id_admin,$judul,$oleh,$file){
		$hsl=$this->db->query("INSERT INTO tbl_files(file_id,pengguna_id,Nama_file,file_oleh,file_data) VALUES ('','$id_admin','$judul','$oleh','$file')");
		return $hsl;
	}
