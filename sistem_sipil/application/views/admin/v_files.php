  										...
  										<tbody>
  											...
  											foreach ($data->result_array() as $i) :
  												...
  												<tr>
  													...
  													<td><?php echo $nim1;?></td>
  													<td><?php echo $nim2;?></td>
  													<td><a href="<?php echo base_url().'admin/files/download1/'.$id;?>"><?php echo $trans1;?></a></td>
  													<td><a href="<?php echo base_url().'admin/files/download2/'.$id;?>"><?php echo $trans2;?></a></td>
  		...
  		<div class="modal-dialog" role="document">
  			<div class="modal-content">
  				...
  				<form class="form-horizontal" action="<?php echo base_url().'admin/files/hapus_file'?>" method="post" enctype="multipart/form-data">
  					<div class="modal-body">
  						<input type="hidden" name="kode" value="<?php echo $id;?>"/>
  						<input type="hidden" name="file1" value="<?php echo $trans1;?>">
              <input type="hidden" name="file2" value="<?php echo $trans2;?>">
  						<p>Apakah Anda yakin mau menghapus file <b><?php echo $nama1;?></b> ?</p>
