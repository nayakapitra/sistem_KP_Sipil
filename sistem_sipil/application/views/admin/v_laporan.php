...
<head>
	...
	<title>Data Berkas Laporan</title>
  		...
  		<div class="content-wrapper">
  			...
  			<section class="content-header">
  				...
  				<ol class="breadcrumb">
  					...
  					<li class="active">Data Berkas Laporan</li>
  				</ol>
  			</section>
  										...
  										<tbody>
  											...
  											foreach ($data->result_array() as $i) :
  												...
  												<tr>
  													...
  													<td><?php echo $nim1;?></td>
  													<td><?php echo $nim2;?></td>
  													<td><a href="<?php echo base_url().'admin/laporan/download/'.$id;?>"><?php echo $file;?></a></td>
  	...
  	<div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  		<div class="modal-dialog" role="document">
  			<div class="modal-content">
  				...
  				<form class="form-horizontal" action="<?php echo base_url().'admin/laporan/hapus_file'?>" method="post" enctype="multipart/form-data">
  					<div class="modal-body">
  						<input type="hidden" name="kode" value="<?php echo $id;?>"/>
