  									...
  									<table id="example1" class="table table-striped" style="font-size:12px;">
  										<thead>
  											<tr>
  												...
  												<th>Nama 1</th>
  												<th>Nama 2</th>
  												<th>File Mulai Kerja Praktek</th>
  												<th>File Selesai Kerja Praktek</th>
  												<th>Status</th>
  										...
  										<tbody>
  											...
  											foreach ($data->result_array() as $i) :
  												...
  												$file1=$i['data1'];
  												$file2=$i['data2'];
  												$status=$i['status_surat'];
  												?>
  												<tr>
  													<td><?php echo $no;?></td>
  													<td><?php echo $nama1?></td>
  													<td><?php echo $nama2;?></td>
  													<td><a href="<?php echo base_url().'admin/surat/download1/'.$id;?>"><?php echo $file1;?></a></td>
  													<td><a href="<?php echo base_url().'admin/surat/download2/'.$id;?>"><?php echo $file2;?></a></td>
  ...
  <?php foreach ($data->result_array() as $i) :
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url().'admin/surat/update_file'?>" method="post" enctype="multipart/form-data">
  	...
  	<div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  		<div class="modal-dialog" role="document">
  			<div class="modal-content">
  				...
  				<form class="form-horizontal" action="<?php echo base_url().'admin/surat/hapus_file'?>" method="post" enctype="multipart/form-data">
  					<div class="modal-body">
  						<input type="hidden" name="kode" value="<?php echo $id;?>"/>
  						<input type="hidden" name="file" value="<?php echo $file1;?>">
              <input type="hidden" name="file" value="<?php echo $file2;?>">
